...
const Header = () => {
    ...
    return (
        <>
            <div className='flex justify-between items-center mb-4 sticky top-0 z-50 bg-white/10 backdrop-blur-md px-4 py-2'>
                <div className="relative w-[20%]">
                    <div className="bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 p-[2px] rounded-xl shadow-lg">
                ...
                <input
                        ...
                        value={searchItem}
                        className="w-full pl-4 border rounded focus:outline-none focus:ring focus:ring-blue-300 "
                    />
                    ...
                    <Link title='History' to={'/HistoryPage'}>
                        <button className="cursor-pointer border px-4 py-2 rounded-sm flex items-center gap-2">
                            <FolderClock />
                        </button>
                    </Link>
                    <ThemeToggle />

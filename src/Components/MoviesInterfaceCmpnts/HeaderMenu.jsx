    ...
    <Menubar className={`mx-4 mb-6 bg-gray-[#182423] `}>
      ...
      <MenubarMenu>
        ...
        <MenubarContent>
          ...
          <MenubarSeparator />
          <MenubarItem onClick={() => handleVoteClick("1-500")}>
            1-500
          </MenubarItem>
          <MenubarSeparator />
          <MenubarItem onClick={() => handleVoteClick("501-1000")}>
            501-1000
          </MenubarItem>
          <MenubarSeparator />
          <MenubarItem onClick={() => handleVoteClick("1000+")}>
            1000+
          </MenubarItem>
        </MenubarContent>
      </MenubarMenu>
      <MenubarMenu>
        ...
        <MenubarContent>
          <MenubarItem onClick={() => handleAverageClick("all")}>
            All
          </MenubarItem>
          <MenubarSeparator />
          <MenubarItem onClick={() => handleAverageClick("1-5")}>
            1-5
          </MenubarItem>
          <MenubarSeparator />
